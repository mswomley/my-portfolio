    ...
    return (
        ...
        <div className="projects">
            <div className="left">
                ...
                <p><svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
                ...
                <p>This is a WordPress site for my friend's art portfolio, check it out!</p>
                    <p><a href="https://artbylina.wordpress.com/"><button className="button1" >View Site</button></a></p>
            </div>
